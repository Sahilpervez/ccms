                  ...
                  child: ClipRRect(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          const ClipOval(
                            child: Image(image: AssetImage(ImageAssets.kLeadProfilePic1),height: 80,width: 80,),
                          ),
                          const SizedBox(height: 10),
                          const Text("Alam Sahilpervez",style: TextStyle(fontFamily: AssetFonts.nunitosans,fontWeight: FontWeight.w700,fontSize: 20)),
                          Text("alamsa48_soe",style: TextStyle(fontFamily: AssetFonts.nunitosans,fontWeight: FontWeight.w500,fontSize: 16,color: Colors.grey.shade600)),
                        ],
                      ),
                    ),
                  ),
                            ...
                            (t, index) => InkWell(
                              ...
                              child:
                                  Padding(
                                    ...
                                    child: AppDrawerMenus(data: data, index: index, t: t),
                                  ),
                            ),
                          )
                          .toList(),
