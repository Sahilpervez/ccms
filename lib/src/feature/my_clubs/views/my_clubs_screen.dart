...
class MyClubsScreen extends ConsumerStatefulWidget {
  ...
  static const routePath = "/myClubs";
                ...
                builder: (context, snapshot) {
                  ...
                  if (snapshot.connectionState == ConnectionState.waiting) {
                    ...
                    return Column(children: [
                      ...
                      const ScreenHeader(header: "My Clubs"),
                      Align(
                  ...
                  if (snapshot.connectionState == ConnectionState.done) {
                    if (data != null) {
                      clubs.clear();
                      log(data.toString(),name: "FILTERING PHASE");
                      data.retainWhere(
                        (t) {
                          // print("CURRENT ELEMENT = $t");
                          ...
                          if ((userData!.map((e) {
                            return e.name;
                              ...
                              .contains((t.clubName.replaceAll(".", ""))
                                  .toLowerCase())) {
                            return true;
                          }
                          return false;
